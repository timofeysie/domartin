...
public class JsonTest extends TestCase 
{
	...
	public void testVocabularyLearningObject() 
	{
	    ...
	    definition.setName("ko-KR", "°íŸçÀÌ");
	    definition.setDescription("Reading");
	    definition.setType("http://ko.wiktionary.org/wiki/°íŸçÀÌ");
        ...
        buffer.append("\"name\": {\"ko-KR\": \"°íŸçÀÌ\"},");
        buffer.append("\"description\": \"Reading\",");
        buffer.append("\"type\": \"http://ko.wiktionary.org/wiki/°íŸçÀÌ\"");
        buffer.append("}}");
